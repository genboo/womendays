...
class WeekPageAdapter(val context: Context, private val calendar: Calendar) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val adapter = CalendarDaysAdapter(context, R.layout.list_item_day, days, null)
